...
int main() {
    ...
    Window window = XCreateSimpleWindow(display, RootWindow(display, screen_num), 0, 0, 640, 480, 0, 0, 0);
    ...
    int win_x, win_y;
    Window child;
    XTranslateCoordinates(display, window, RootWindow(display, screen_num), -50000, -50000, &win_x, &win_y, &child);
